 ...
 */ 
class sspmod_janus_Xml_Duration_Parser
{
    /**
    ...
    public function parse()
    {
        ...
        if ($this->_token !== 'P') {
            throw new sspmod_janus_Xml_Duration_Parser_FormatException(
                "Duration '{$this->_duration}' is not in the XML duration format?!?"
            );
        }
    ...
    protected function _parseDateModifier($number)
    {
        if ($this->_token === 'Y') {
            ...
            throw new sspmod_janus_Xml_Duration_Parser_FormatException(
                "Unrecognized token '$this->_token' in '{$this->_duration}'"
            );
        }
    }
