...
use Acme\DemoBundle\Form\ConnectionType;
use Acme\DemoBundle\Model\Connection;
use Acme\DemoBundle\Model\ConnectionCollection;
...
class ConnectionController extends FOSRestController
{
     ...
     * @ApiDoc(
     *   resource = true,
     *   output = "Acme\DemoBundle\Model\Connection",
     *   statusCodes = {
     *     200 = "Returned when successful",
     ...
     * @ApiDoc(
     *   resource = true,
     *   input = "Acme\DemoBundle\Form\ConnectionType",
     *   statusCodes = {
     *     200 = "Returned when successful",
     ...
     *
     * @Annotations\View(
     *   template = "AcmeDemoBundle:Connection:newConnection.html.twig",
     ...
     *
     * @Annotations\View(
     *   template="AcmeDemoBundle:Connection:editConnection.html.twig"
     * )
     *
     * @param Request $request the request object
     * @param int     $id      the connection id
