...
class Connection
{
     ...
     *
     * @ORM\OneToMany(targetEntity="Janus\Entity\Connection\Revision", mappedBy="connection", cascade={"persist", "remove"})
     */
    protected $revisions;
     ...
     * @var ArrayCollection
     *
     * @ORM\OneToMany(targetEntity="Janus\Entity\User\ConnectionRelation", mappedBy="connection")
     */
