...
/**
 * @ORM\Entity(
 *  repositoryClass="Janus\Entity\Connection\RevisionRepository"
 * )
 * @ORM\Table(
...
class Revision
{
    ...
    /**
     @var Connection
     *
     * @ORM\ManyToOne(targetEntity="Janus\Entity\Connection", inversedBy="revisions")
     ...
     *
     * @ORM\OneToMany(targetEntity="Janus\Entity\Connection\Revision\Metadata", mappedBy="connectionRevision", fetch="LAZY")
     * @Serializer\Groups({"compare"})
     *
     */
    protected $metadata;
     ...
     * @var array
     *
     * @ORM\OneToMany(targetEntity="Janus\Entity\Connection\Revision\AllowedConnectionRelation", mappedBy="connectionRevision")
     * @Serializer\Groups({"compare"})
     */
     ...
     * @var array
     *
     * @ORM\OneToMany(targetEntity="Janus\Entity\Connection\Revision\BlockedConnectionRelation", mappedBy="connectionRevision")
     * @Serializer\Groups({"compare"})
     */
     ...
     * @var array
     *
     * @ORM\OneToMany(targetEntity="Janus\Entity\Connection\Revision\DisableConsentRelation", mappedBy="connectionRevision")
     * @Serializer\Groups({"compare"})
     */
    ...
    public function toDto()
    {
        ...
        if ($this->metadata instanceof PersistentCollection) {
            $flatMetadata = array();
            /** @var $metadataRecord Janus\Entity\Connection\Revision\Metadata */
        ...
        if ($this->allowedConnectionRelations instanceof PersistentCollection) {
            ...
            /** @var $relation Janus\Entity\Connection\Revision\AllowedConnectionRelation */
        ...
        if ($this->blockedConnectionRelations instanceof PersistentCollection) {
            ...
            /** @var $relation Janus\Entity\Connection\Revision\BlockedConnectionRelation */
        ...
        if ($this->disableConsentConnectionRelations instanceof PersistentCollection) {
            ...
            /** @var $relation Janus\Entity\Connection\Revision\DisableConsentRelation */
