...
class DisableConsentRelation
{
     ...
     *
     * @ORM\Id
     * @ORM\ManyToOne(targetEntity="Janus\Entity\Connection\Revision", inversedBy="disableConsentConnectionRelations")
     ...
     *
     * @ORM\Id
     * @ORM\ManyToOne(targetEntity="Janus\Entity\Connection")
