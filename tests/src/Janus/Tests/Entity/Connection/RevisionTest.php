<?php
namespace Janus\Tests\Entity\Connection;
...
class RevisionTest extends PHPUnit_Framework_TestCase
{
    ...
    {
        $this->connection = Phake::mock('Janus\Entity\Connection');
        $this->revisionNr = 0;
    ...
    public function testInstantiation()
    {
        ...
        $this->assertInstanceOf('Janus\Entity\Connection\Revision', $connectionRevision);
    }
