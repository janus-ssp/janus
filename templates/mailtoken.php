...
?>
	...
	<?php if ($this->data['msg'] !== NULL) { ?>
		...
		?>
		<p><?php echo $this->t($this->data['msg']); ?></p>
		</div>
	<?php
   		} else {
			$showform = TRUE;
		...
		if($showform) {
			?>
	<h2 style="break: both"><?php echo $this->t('text_user_mail_header'); ?></h2>
	
	<p><?php echo $this->t('text_user_mail_text'); ?></p>
	...
	<table>
		<tr>
			...
			<td>
				<input type="text" id="mail" tabindex="1" name="mail" /></td>
