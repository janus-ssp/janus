...
<div id="tabdiv">
    <p style="font-size: large; text-align: center;">
        <a href="<?php echo SimpleSAML_Module::getModuleURL('janus/pages/index.php'); ?>">
    ...
    <hr />
    <p style="font-size: large; text-align: center;">
        <a href="<?php echo SimpleSAML_Module::getModuleURL('janus/pages/index.php'); ?>">Go back to the JANUS Dashboard</a>
    </p>
</div>
