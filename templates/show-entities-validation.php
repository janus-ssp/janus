...
<div id="tabdiv">
    <p style="font-size: large; text-align: center;">
        <a href="<?php echo \SimpleSAML\Module::getModuleURL('janus/index.php'); ?>">
    ...
    <hr />
    <p style="font-size: large; text-align: center;">
        <a href="<?php echo \SimpleSAML\Module::getModuleURL('janus/index.php'); ?>">Go back to the JANUS Dashboard</a>
    </p>
</div>
