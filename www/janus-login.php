...
$correctpassword = $janus_config->getValue('password', '123');
...
$t = new SimpleSAML_XHTML_Template($config, 'janus:janus-login.php', 'login');

$t->data['header'] = 'JANUS: Enter username and password';	
