 ...
 */
class sspmod_janus_OpenSsl_Certificate_Chain_Factory
{
    ...
    public static function loadRootCertificatesFromFile($filePath)
    {
        ...
        $certificatesFound = sspmod_janus_OpenSsl_Certificate_Utility::getCertificatesFromText($fileContents);
    ...
    public static function createFromPems(array $pems)
    {
        $chain = new sspmod_janus_OpenSsl_Certificate_Chain();
        foreach ($pems as $pem) {
            $certificate = new sspmod_janus_OpenSsl_Certificate($pem);
