...
define('JANUS_DEFAULT_VALID_UNTIL', '+1 year');
define('JANUS_DEFAULT_CACHE_UNTIL', '+1 day');

/**
 *
 */ 
class sspmod_janus_Cron_Job_MetadataRefresh extends sspmod_janus_Cron_Job_Abstract
{
    ...
    protected function _getMetaDataCachingInfo($xml, $entityId)
    {
        ...
        $defaultValidUntil = strtotime(JANUS_DEFAULT_VALID_UNTIL);
        ...
        $defaultCacheDuration = strtotime(JANUS_DEFAULT_CACHE_UNTIL);
    ...
    protected function _getEarliestDateFromXmlDuration($timeStamp, $xmlDuration)
    {
        ...
        $xmlTimeStamp = time() + sspmod_janus_Xml_Duration::createFromDuration($xmlDuration->item(0)->nodeValue)->getSeconds();
